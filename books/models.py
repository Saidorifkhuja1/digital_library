...
class Book(models.Model):
    ...
    uploaded_by = models.ManyToManyField('accounts.User', related_name='books_uploaded', blank=True)
    read_by = models.ManyToManyField('accounts.User', related_name='books_read', blank=True)
